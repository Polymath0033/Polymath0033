...
I’m a product-minded software engineer who works across the stack—with a frontend focus and a backend backbone.

I treat every project like it’s mine. I care about usability, reliability, and the long-term experience of the people using what I build.

- ⚙️ **Frontend:** Vue, React, Nuxt, Next.js, TypeScript
- 🚀 **Backend:** Java + Spring Boot (REST, GraphQL, WebSockets, Auth, Microservices)
- 🔌 **Tools & Platforms:** Supabase, Firebase, GitHub Actions, CI/CD, RDBMS
- 📱 **Mobile (light):** Flutter + Riverpod
- 🌍 **Other:** I love browser extensions and real-world problem solving
- 🎙️ **Speaker:** I talk about engineering, learning, and shipping great software

---

### 👀 I’m currently:
- Learning to write more advanced SQL queries
- Building tools that improve product workflows
- Speaking at meetups about backend & developer tools
- Looking to collaborate on meaningful frontend/backend projects
